...
description: Aurexus Group Ltd principles and practices for developing and deploying artificial intelligence responsibly across its platforms and services.
...
See our [AI Transparency Statement](/legal/ai-transparency).
...
See our [Privacy Policy](/legal/privacy-policy) and [Information Security Policy](/legal/information-security).
...
See our [Environmental Policy](/legal/environmental).
...
| Role | Responsibility |
|---|---|
| Leadership | Set tone, allocate resources, approve high-risk AI deployments |
| Engineering teams | Implement controls, testing and documentation |
| Product owners | Define intended use, acceptance criteria and user guidance |
| Clients and users | Apply AI within authorised scope, maintain oversight, report issues |
| Partners | Comply with this policy when contributing to Aurexus AI systems |
...
See our [Acceptable Use Policy](/legal/acceptable-use).
